gkbrkn_localization = {
    ...
    game_modifier_goo_mode_description = "Outrun the goo!",
    game_modifier_killer_goo_mode_name = "Killer Goo Mode",
    game_modifier_killer_goo_mode_description = "Outrun the killer goo!",
    game_modifier_alt_killer_goo_mode_name = "Killer Goo Mode (Alt)",
    game_modifier_alt_killer_goo_mode_description = "Outrun the killer goo! Performance improvements?",
    game_modifier_poly_goo_mode_name = "Poly Goo Mode",
    game_modifier_poly_goo_mode_description = "Outrun the polymorph goo!",
    game_modifier_hot_goo_mode_description = "Outrun the hot goo!",
