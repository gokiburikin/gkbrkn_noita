gkbrkn_localization = {
    ...
    option_legendary_wands = "Legendary Wands",
    ...
    ui_icon_name_champion_mode_mini_boss = "Champions-Only Mini-Boss Mode",
    ui_icon_name_champion_mode_super = "Super Champions Mode",
    ui_icon_name_champion_mode_mini_boss_super = "Super Mini-Boss Mode",
    ...
    action_description_carry_shot = "Cast a spell that is held in place a set distance from the tip of your wand",
    ...
    action_description_protective_enchantment = "Cast a spell that can not deal direct damage to you",
    action_name_chain_cast = "Chain Cast",
    action_description_chain_cast = "Chain cast 4 spells",
    ...
    loadout_demolitionist = "Demolistionist",
    ...
    loadout_treasure_hunter = "Treasure Hunter",
