gkbrkn_localization = {
    ...
    option_deprecated_content = "Show Deprecated Content",
    option_deprecated_content_description = "Allow the toggling of content that was removed from Goki's Things",
    ...
    action_description_piercing_shot = "Projectiles pierce entities, passing through them",
    action_name_perforating_shot = "Perforating Shot",
    action_description_perforating_shot = "Projectiles perforates entities, passing through them",
    ...
    action_name_hyper_bounce = "Hyper Bounce",
    action_description_hyper_bounce = "Cast a spell that bounces (almost) forever",
    ...
    action_description_feather_shot = "The projectile has reduced terminal velocity",
    ...
    action_description_duplicast = "Fire the projectile many times in a circular pattern",
    ...
    action_name_zero_gravity = "Zero-gravity",
    action_description_zero_gravity = "The projectile is unaffected by gravity",
    action_name_reduce_knockback = "Reduce Knockback",
    action_description_reduce_knockback = "Decreases the knockback of the projectile",
    action_name_speed_down = "Speed Down",
    ...
    tweak_name_piercing_shot = GameTextGetTranslatedOrNot("$action_piercing_shot").." Fix",
    tweak_name_piercing_shot_description = "Modifier works on frame 1 instead of frame 2",
    tweak_name_clipping_shot = GameTextGetTranslatedOrNot("$action_clipping_shot").." Fix",
    tweak_name_clipping_shot_description = "Modifier works on frame 1 instead of frame 2",
    ...
    game_modifier_limited_mana_name = "Limited Mana",
    game_modifier_limited_mana_description = "Wands have more mana, but do not recharge mana.",
    game_modifier_goo_mode_name = "Goo Mode",
    game_modifier_goo_mode_description = "Try to outrun the ever expanding goo! You'll drown if you get stuck in it, so move quickly!",
    game_modifier_killer_goo_mode_name = "Killer Goo Mode",
    game_modifier_killer_goo_mode_description = "A mysterious killer goo is consuming everything it touches! Avoid it at all cost!",
    game_modifier_alt_killer_goo_mode_name = "Corruption Goo Mode",
    game_modifier_alt_killer_goo_mode_description = "Corruption is spreading and converting the world. Don't get caught up in it!",
    game_modifier_poly_goo_mode_name = "Poly Goo Mode",
    game_modifier_poly_goo_mode_description = "Some pretty pink goo is making everything cute and fluffy. Will this be your fate, too?",
    game_modifier_hot_goo_mode_name = "Hot Goo Mode",
    game_modifier_hot_goo_mode_description = "The floor is lava? How about the world is lava! Get away from that hot goo!",
    game_modifier_hard_mode_name = "Hard Mode",
    game_modifier_hard_mode_description = "Rebalance aspects of the game to be more difficult.",
    game_modifier_no_wand_generation_name = "No Wand Generation",
    game_modifier_no_wand_generation_description = "Wands will not generate naturally in the world.",
    game_modifier_no_edit_name = "No Wand Editing",
    game_modifier_no_edit_description = "You can not edit wands.",
    game_modifier_no_hit_name = "No Hit",
    game_modifier_no_hit_description = "You die in one hit.",
    game_modifier_limited_ammo_name = "Limited Ammo",
    game_modifier_limited_ammo_description = "Unlimited use spells become limited.",
    game_modifier_unlimited_ammo_name = "Unlimited Ammo",
    game_modifier_unlimited_ammo_description = "Limited use spells become unlimited.",
    game_modifier_guaranteed_always_cast_name = "Guaranteed Always Cast",
    game_modifier_guaranteed_always_cast_description = "Generated wands will have at least 1 Always Cast spell.",
    game_modifier_shuffle_wands_only_name = "Shuffle Wands Only",
    game_modifier_shuffle_wands_only_description = "Generated wands will be Shuffle: Yes.",
    game_modifier_order_wands_only_name = "Order Wands Only",
    game_modifier_order_wands_only_description = "Generated wands will be Shuffle: No.",
    game_modifier_wand_shops_only_name = "Wand Shops Only",
    game_modifier_wand_shops_only_description = "Shops will only have wands in them.",
    game_modifier_spell_shops_only_name = "Spell Shops Only",
    game_modifier_spell_shops_only_description = "Shops will only have spells in them.",
    game_modifier_free_shops_name = "Free Shops",
    game_modifier_free_shops_description = "Items in the shop will cost no gold.",
    game_modifier_floor_is_lava_name = "Floor is Lava",
    game_modifier_floor_is_lava_description = "You take damage while grounded.",
    game_modifier_infinite_flight_name = "Unlimited Levitation",
    game_modifier_infinite_flight_description = "You can levitate freely.",
    game_modifier_disintegrate_corpses_name = "Disintegrate Corpses",
    game_modifier_disintegrate_corpses_description = "Your kills leave no corpses behind.",
    game_modifier_remove_generic_wands_name = "Remove Generic Wands",
    game_modifier_remove_generic_wands_description = "Wands that aren't considered special (loadouts, challenges, duplicates, merged, etc.) are removed from the world.",
    game_modifier_angry_gods_name = "Angry Gods",
