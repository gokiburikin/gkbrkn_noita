gkbrkn_localization = {
    ...
    action_description_follow_shot = "Cast a spell that is influenced by your movements",
    ...
    action_description_clinging_shot = "Cast a spell that locks onto a nearby target",
    action_name_duplicast = "Duplicast",
