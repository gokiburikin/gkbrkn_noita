table.insert( actions,
{
    ...
    sprite 		= "mods/gkbrkn_noita/files/gkbrkn/actions/golden_blessing/icon.png",
    sprite_unidentified = "mods/gkbrkn_noita/files/gkbrkn/actions/golden_blessing/icon.png",
