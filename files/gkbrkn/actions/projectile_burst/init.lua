table.insert( actions,
{
    ...
    sprite 		= "mods/gkbrkn_noita/files/gkbrkn/actions/projectile_burst/icon.png",
    sprite_unidentified = "mods/gkbrkn_noita/files/gkbrkn/actions/projectile_burst/icon.png",
