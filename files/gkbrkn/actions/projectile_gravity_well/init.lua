table.insert( actions,
{
    ...
    sprite 		= "mods/gkbrkn_noita/files/gkbrkn/actions/projectile_gravity_well/icon.png",
    sprite_unidentified = "mods/gkbrkn_noita/files/gkbrkn/actions/projectile_gravity_well/icon.png",
