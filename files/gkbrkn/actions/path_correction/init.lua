table.insert( actions,
{
    ...
    sprite 		= "mods/gkbrkn_noita/files/gkbrkn/actions/path_correction/icon.png",
    sprite_unidentified = "mods/gkbrkn_noita/files/gkbrkn/actions/path_correction/icon.png",
