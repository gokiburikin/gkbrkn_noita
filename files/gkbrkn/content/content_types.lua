...
content_types = {
    ...
    {
        id = "starting_perk",
        display_name = "$config_content_type_name_gkbrkn_starting_perk",
        short_name = "starting_perks",
        shared_content_filepath = "data/scripts/perks/perk_list.lua",
        shared_content_table = "perk_list",
        content_filepath = "mods/gkbrkn_noita/files/gkbrkn/content/starting_perks.lua",
        content_table = "starting_perks",
        cache_filepath = "mods/gkbrkn_noita/files/gkbkrn/scratch/starting_perks_cache.lua",
        cache_table = "starting_perks_cache",
        content_disable_callback = function( content, current_string ) return current_string end,
    },
    {
        id = "loadout",
    ...
    {
        id = "event",
        display_name = "$config_content_type_name_gkbrkn_event",
        short_name = "events",
